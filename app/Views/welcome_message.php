...
<header>
        ...
        <ul>
            <li class="logo">
                <a href="https://codeigniter.com" target="_blank">
                    <img src="https://lirp-cdn.multiscreensite.com/60617cdc/dms3rep/multi/opt/Atica_ArteFinalLogo-4-eeec0b3e-640w.png" height="50px" alt="CodeIgniter logo">    
                </a>
            </li>
            ...
            <li class="menu-item hidden"><a href="login.php">Login</a></li>
            <li class="menu-item hidden"><a href="https://codeigniter.com/user_guide/" target="_blank">Docs</a>
            </li>
            <li class="menu-item hidden">    <p>Has iniciado sesión como: <strong><?php echo htmlspecialchars($correoUsuario); ?></strong></p>
            </li>
            <li class="menu-item hidden">   <a href="logout.php">Cerrar sesión</a>
    ...
    <div class="heroe">
        ...
        <h1>Bienvenidos al Generador de Contraseñas</h1>

        <h2>por favor registrate o inicia sesion si ya tienes una cuenta</h2>
