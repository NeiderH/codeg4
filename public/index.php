...
$generatedPassword = $_SESSION['generated_password'] ?? null; // Obtén la contraseña de la sesión
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<header>
    ...
    <div class="heroe">
        ...
        <h2>Por favor no te olvides de guardar la contraseña que se te concedió:</h2>
        <p><strong><?php echo htmlspecialchars($generatedPassword); ?></strong></p>
        <?php unset($_SESSION['generated_password']); // Elimina la contraseña de la sesión después de mostrarla ?>
    <?php endif; ?>
